...
public class RankingQuestionStatus : BaseEntity
{
    /// <summary>
    ///     Survey was just created and is only view- and editable by the creator/admin.
    /// </summary>
    public static readonly RankingQuestionStatus New = new() { Id = 1, Identifier = "NEW", Name = "new" };

    /// <summary>
    ///     Survey was published and can not be edited anymore. Users can find the survey with its invitation ID.
    /// </summary>
    public static readonly RankingQuestionStatus Published = new()
    {
        Id = 2, Identifier = "PUBLISHED", Name = "published"
    };

    /// <summary>
    ///     At least one user already responded to the survey.
    /// </summary>
    public static readonly RankingQuestionStatus InProgress =
    ...
    /// </summary>
    public static readonly RankingQuestionStatus Completed = new()
    {
        Id = 4, Identifier = "COMPLETED", Name = "completed"
    };

    /// <summary>
    ///     The survey was archived by the creator/admin. Users cannot reach it anymore with their invitation ID.
    /// </summary>
    public static readonly RankingQuestionStatus
